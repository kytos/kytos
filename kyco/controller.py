...
class Controller(object):
    ...
    Attributes:
        ...
        napps (dict): The key is the napp name (string), while the value is the
            napp instance itself
        options (object): Object generated by ParseArgs on config.py file
        server (KycoServer): Instance of KycoServer that will be listening to
            TCP connections.
        switches (dict): Dict with the current existing switches. The key is
