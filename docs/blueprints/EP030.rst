...
- The minimum expected liveness hello interval is 1s and the dead interval should be three times the hello interval. If three subsequent hellos aren't received the liveness status should be considered down.
...
- For production networks, on average, there will be 30 links in total and 3 links per switch, to give a ballpark figure for stress testing and making sure that the minimum hello of 1s works as expected.
